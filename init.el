...
(custom-set-variables
 ...
 '(package-selected-packages (quote (neotree feature-mode elisp-format cider clojure-mode
					     taskpaper-mode markdown-mode lsp-python magit deft
					     dracula-theme rainbow-identifiers rainbow-delimiters
					     which-key indent-guide no-easy-keys ace-jump-mode
					     lsp-mode company flycheck counsel-projectile counsel
					     projectile exec-path-from-shell smex smartparens
					     use-package))))
(custom-set-faces
