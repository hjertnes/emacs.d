...
(setq org-roam-link-auto-replace t org-roam-directory (file-truename "~/txt/roam/") org-roam-tag-sources '(prop all-directories))
(setq org-roam-dailies-directory "Daily Notes/")
(setq org-roam-dailies-capture-templates
      '(("d" "default" entry
         #'org-roam-capture--get-point
         "* %?"
         :file-name "Daily Notes/%<%Y-%m-%d>"
         :head "#+title: %<%Y-%m-%d>\n\n")))
