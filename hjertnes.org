...
#+END_SRC
** Theme
I currently use a modified version of Dracula, based on the palette of Dracula Pro.
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
#+BEGIN_SRC emacs-lisp
(use-package org-superstar :ensure t :config (org-superstar-mode 1))
#+END_SRC
...
(use-package deft
  ...
  (deft-directory "~/txt/roam"))
(setq org-roam-directory "~/txt/roam/" org-roam-tag-sources '(prop all-directories))
